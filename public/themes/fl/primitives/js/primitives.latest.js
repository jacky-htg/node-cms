/**
 * @preserve Basic Primitives orgDiagram v2.1.5
        ...
        if (connectorRect.height < connectorRect.width) {
            ...
            for (index = 0, len = offsets.length; index < len; index += 1) {
                ...
                buffer.addInverted(function (invertedBuffer) {
                    ...
                    polyline.segments.push(new primitives.common.MoveSegment(fromPoint.x, fromPoint.y + tempOffset));
                    polyline.segments.push(new primitives.common.QuadraticArcSegment(connectorRect.horizontalCenter(), (invertY ? connectorRect.top() : connectorRect.bottom()) + tempOffset,
                        toPoint.x, toPoint.y + tempOffset));
                }, !index);//ignore jslint

                polyline.addArrow(this.lineWidth, function (segments, paletteItem) {
                    var arrowPolyline = buffer.getPolyline(paletteItem);
                    arrowPolyline.segments = arrowPolyline.segments.concat(segments);
                }); //ignore jslint
            }
            ...
            for (index = 0, len = offsets.length; index < len; index += 1) {
                ...
                buffer.addInverted(function (invertedBuffer) {
                    var polyline = invertedBuffer.getPolyline(linePaletteItem);
                    polyline.segments.push(new primitives.common.MoveSegment(fromPoint.x, fromPoint.y + tempOffset));
                    polyline.segments.push(new primitives.common.QuadraticArcSegment(connectorRect.horizontalCenter() + tempOffset * (invertY != invertX ? 1 : -1), (invertY ? connectorRect.top() : connectorRect.bottom()) + tempOffset,
                        connectorRect.horizontalCenter() + tempOffset * (invertY != invertX ? 1 : -1), connectorRect.verticalCenter() + tempOffset));
                    polyline.segments.push(new primitives.common.QuadraticArcSegment(connectorRect.horizontalCenter() + tempOffset * (invertY != invertX ? 1 : -1), (invertY ? connectorRect.bottom() : connectorRect.top()) + tempOffset,
                        toPoint.x, toPoint.y + tempOffset));
                }, !index);//ignore jslint
        ...
        if (fromRect.verticalCenter() < toRect.top() || fromRect.verticalCenter() > toRect.bottom()) {
            ...
            for (index = 0, len = offsets.length; index < len; index += 1) {
                ...
                buffer.addInverted(function (invertedBuffer) {
                    var polyline = invertedBuffer.getPolyline(linePaletteItem);
                    polyline.segments.push(new primitives.common.MoveSegment(fromPoint.x, fromPoint.y + tempOffset));
                    polyline.segments.push(new primitives.common.QuadraticArcSegment(invertX ? connectorRect.right() + tempOffset * (invertY ? -1 : 1) : connectorRect.left() - tempOffset * (invertY ? -1 : 1), connectorRect.verticalCenter(),
            ...
            for (index = 0, len = offsets.length; index < len; index += 1) {
                ...
                buffer.addInverted(function (invertedBuffer) {
                    var polyline = invertedBuffer.getPolyline(linePaletteItem);
                    polyline.segments.push(new primitives.common.MoveSegment(fromPoint.x + tempOffset, fromPoint.y));
                    polyline.segments.push(new primitives.common.QuadraticArcSegment(connectorRect.horizontalCenter(), connectorRect.top() - tempOffset * (invertX ? -1 : 1),
...
primitives.common.Perimeter.prototype.draw = function (perimeter) {
    ...
    perimeter.segments.iterate(function (item) {
        ...
        if (polyline.segments.length == 0) {
            ...
            polyline.segments.push(prevPoint);
        ...
        polyline.segments.push(newPoint);
	...
	element = this.m_graphics.polyline(polyline.segments, polyline.paletteItem.toAttr());
};
        ...
        default:
            ...
            switch (this.shapeType) {
                ...
                case 1/*primitives.common.ShapeType.Oval*/: //ignore jslint
                    ...
                    polyline.segments.push(new primitives.common.MoveSegment(position.x, position.verticalCenter()));
                    polyline.segments.push(new primitives.common.CubicArcSegment(position.x, position.verticalCenter() - cpY, position.horizontalCenter() - cpX, position.y, position.horizontalCenter(), position.y));
                    polyline.segments.push(new primitives.common.CubicArcSegment(position.horizontalCenter() + cpX, position.y, position.right(), position.verticalCenter() - cpY, position.right(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.CubicArcSegment(position.right(), position.verticalCenter() + cpY, position.horizontalCenter() + cpX, position.bottom(), position.horizontalCenter(), position.bottom()));
                    polyline.segments.push(new primitives.common.CubicArcSegment(position.horizontalCenter() - cpX, position.bottom(), position.x, position.verticalCenter() + cpY, position.x, position.verticalCenter()));
                    break;
                case 5/*primitives.common.ShapeType.Rhombus*/:
                    polyline.segments.push(new primitives.common.MoveSegment(position.horizontalCenter(), position.bottom()));
                    polyline.segments.push(new primitives.common.LineSegment(position.left(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.horizontalCenter(), position.y));
                    polyline.segments.push(new primitives.common.LineSegment(position.right(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.horizontalCenter(), position.bottom()));
                    break;
                case 2/*primitives.common.ShapeType.Triangle*/:
                    polyline.segments.push(new primitives.common.MoveSegment(position.left(), position.bottom()));
                    polyline.segments.push(new primitives.common.LineSegment(position.horizontalCenter(), position.y));
                    polyline.segments.push(new primitives.common.LineSegment(position.right(), position.bottom()));
                    polyline.segments.push(new primitives.common.LineSegment(position.left(), position.bottom()));
                    break;
                case 3/*primitives.common.ShapeType.CrossOut*/:
                    polyline.segments.push(new primitives.common.MoveSegment(position.horizontalCenter(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.x, position.y));
                    polyline.segments.push(new primitives.common.MoveSegment(position.horizontalCenter(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.right(), position.bottom()));
                    polyline.segments.push(new primitives.common.MoveSegment(position.horizontalCenter(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.right(), position.y));
                    polyline.segments.push(new primitives.common.MoveSegment(position.horizontalCenter(), position.verticalCenter()));
                    polyline.segments.push(new primitives.common.LineSegment(position.left(), position.bottom()));
                    break;
                default:
...
primitives.common.Polyline = function (paletteItem) {
...
primitives.common.Polyline.prototype.transform = function (transform, forward) {
    var index, len, segment;
    for (index = 0, len = this.segments.length; index < len; index += 1) {
        segment = this.segments[index];
        if (segment.transform != null) {
            segment.transform(transform, forward);
        }
    }
};
...
primitives.common.Polyline.prototype.addInverted = function (polyline) {
    var index,
    ...
    if (segments.length > 0) {
        if (this.isInvertable()) {
            startPoint = segments[segments.length - 1].getEndPoint();
            this.segments.push(new primitives.common.MoveSegment(startPoint));

            for (index = segments.length - 1; index > 0; index -= 1) {

                segment = segments[index];
                prevSegment = segments[index - 1];
                if (segment.segmentType != 4/*primitives.common.SegmentType.Dot*/ && prevSegment.segmentType != 4/*primitives.common.SegmentType.Dot*/) {
                    startPoint = prevSegment.getEndPoint();
                    segment.invert(startPoint);
                }
...
primitives.common.Polyline.prototype.addArrow = function (lineWidth, onAddArrowSegments) {
    var prevEndPoint,
        currentEndPoint,
        currentSegment,
        newEndPoint,
        ...
        arrowSegments,
        arrowTipLength = lineWidth * 8,
        arrowTipWidth = lineWidth * 6;

    if (onAddArrowSegments != null && len > 1) {
        prevEndPoint = this.segments[len - 2].getEndPoint();
        currentSegment = this.segments[len - 1];
        if (currentSegment.trim != null) {
            ...
            arrowSegments = this._getArrow(newEndPoint.x, newEndPoint.y, currentEndPoint.x, currentEndPoint.y, arrowTipLength, arrowTipWidth);
            onAddArrowSegments(arrowSegments, this.arrowPaletteItem, newEndPoint);
        }
    }
};
...
primitives.common.Polyline.prototype.optimizeMoveSegments = function () {
    var index, len,
        ...
        jumps = [],
        processed = [];
    for (index = 0, len = this.segments.length; index < len - 1; index += 1) {
        segment = this.segments[index];
        nextSegment = this.segments[index + 1];
        ...
        if (!processed[index]) {
            ...
            if (jumps[index] > 0) {
                ...
                while (cursorIndex < len && !processed[cursorIndex]) {
                    segment = this.segments[cursorIndex];
                    optimizedSegments.push(segment);
    ...
    this.segments = optimizedSegments;
};

primitives.common.Polyline.prototype._getArrow = function (fromX, fromY, toX, toY, length, width) {
    var result = [],
        index, len,
        point, x, y,
...
primitives.common.PolylinesBuffer.prototype._getPolyline = function (polylines, paletteItem) {
...
primitives.common.PolylinesBuffer.prototype.getPolyline = function (paletteItem) {
    return this._getPolyline(this.polylines, paletteItem);
};
...
primitives.common.PolylinesBuffer.prototype.addInverted = function (callbackFun, copyOnly) {
    var pkey,
        backupPolylines,
        polyline, backupPolyline;

    /* backup polylines */    
    backupPolylines = this.polylines;
    this.polylines = [];
    ...
    /* add invert polylines segments to backup collection */
    for (pkey in this.polylines) {
        if (this.polylines.hasOwnProperty(pkey)) {
            polyline = this._getPolyline(this.polylines, pkey);
            backupPolyline = this._getPolyline(backupPolylines, polyline.paletteItem);

            if (!copyOnly) {
                backupPolyline.addInverted(polyline);
            } else {
                backupPolyline.segments = backupPolyline.segments.concat(polyline.segments);
            }
        }
    }

    /* restore polylines */
    this.polylines = backupPolylines;
};

primitives.common.PolylinesBuffer.prototype.transform = function (transform, forward) {
    var key, polyline;
    for (key in this.polylines) {
        if (this.polylines.hasOwnProperty(key)) {
            polyline = this.polylines[key];
            if (polyline) {
                polyline.transform(transform, forward);
            }
        }
    }
};
...
primitives.common.Graphics.prototype.polylinesBuffer = function (buffer) {
    var polylines = buffer.getPolylines(),
        polyline,
        attr,
        element,
        index, len;
    ...
    for (index = 0, len = polylines.length; index < len; index += 1) {
        ...
        if (polyline.segments.length > 0) {
            attr = polyline.paletteItem.toAttr();
            element = this.polyline(polyline.segments, attr);
	        ...
	        this.transform.transformPoints(parentHorizontalCenter, partnersConnectorOffset,
                ...
                true, this, function (fromX, fromY, toX, toY) {
                    ...
                    if (this.showElbowDots && this.options.elbowType != 0/*primitives.common.ElbowType.None*/ && parentTreeItem.partners.length > 0) {
				        dotPolyline.segments.push(new primitives.common.DotSegment(fromX - elbowDotRadius, fromY - elbowDotRadius, elbowDotRadius * 2, elbowDotRadius * 2, elbowDotRadius));
                    }
                    buffer.addInverted(function (invertedBuffer) {
                        var polyline = invertedBuffer.getPolyline(paletteItem);
                        polyline.segments.push(new primitives.common.MoveSegment(toX, toY));
                        polyline.segments.push(new primitives.common.LineSegment(fromX, fromY));
                        ...
                        if (self.options.arrowsDirection == 1/*primitives.common.GroupByType.Parents*/ && parentTreeItem.visibility != 4/*primitives.common.Visibility.Invisible*/ && partnerPoints.length <= 1) {
                            polyline.addArrow(self.options.linesWidth, function (segments, paletteItem) {
                                var arrowPolyline = buffer.getPolyline(paletteItem);
                                arrowPolyline.segments = arrowPolyline.segments.concat(segments);
                            }); //ignore jslint
                        }
                    ...
                    if (this.showElbowDots && this.options.elbowType != 0/*primitives.common.ElbowType.None*/ && points.length > 1) {
				        dotPolyline.segments.push(new primitives.common.DotSegment(toX - elbowDotRadius, toY - elbowDotRadius, elbowDotRadius * 2, elbowDotRadius * 2, elbowDotRadius));
                    }
                });
...
primitives.orgdiagram.BaseController.prototype._drawLineWithArrow = function (fromX, fromY, toX, toY, buffer, polyline, fromVisibility, toVisibility) {
    ...
    polyline.segments.push(new primitives.common.MoveSegment(first));
    polyline.segments.push(new primitives.common.LineSegment(second));
    if (hasArrow) {
        polyline.addArrow(this.options.linesWidth, function (segments, paletteItem) {
            var arrowPolyline = buffer.getPolyline(paletteItem);
            arrowPolyline.segments = arrowPolyline.segments.concat(segments);
        }); //ignore jslint
    }
        ...
        for (index = 2/*primitives.common.ConnectorStyleType.Highlight*/; index >= 0/*primitives.common.ConnectorStyleType.Extra*/; index -= 1) {
            ...
            if (startX != null && startX < leftPosition) {
                this.transform.transformPoints(leftPosition, parentY, startX, parentY, true, this, function (startX, startY, endX, endY) {
                    polyline.segments.push(new primitives.common.MoveSegment(startX, startY));
                    polyline.segments.push(new primitives.common.LineSegment(endX, endY));
                }); //ignore jslint
            ...
            if (connectorPoint.hasElbow) {
                this.transform.transform3Points(connectorPoint.elbowPoint2.x, connectorPoint.elbowPoint2.y,
                    ...
                    function (fromX, fromY, toX, toY, toX2, toY2) {
                        switch (this.options.elbowType) {
                            case 2/*primitives.common.ElbowType.Bevel*/:
                                polyline.segments.push(new primitives.common.MoveSegment(fromX, fromY));
                                polyline.segments.push(new primitives.common.LineSegment(toX2, toY2));
                                break;
                            case 3/*primitives.common.ElbowType.Round*/:
                                polyline.segments.push(new primitives.common.MoveSegment(fromX, fromY));
                                polyline.segments.push(new primitives.common.CubicArcSegment(fromX, fromY, toX, toY, toX2, toY2));
                                break;
                        }
                    });//ignore jslint
                ...
                this.transform.transformPoints(connectorPoint.elbowPoint1.x, connectorPoint.elbowPoint1.y, connectorPoint.x, connectorPoint.y, true, this, function (fromX, fromY, toX, toY) {
                    polyline.segments.push(new primitives.common.LineSegment(toX, toY));
                }); //ignore jslint
            } else {
                this.transform.transformPoints(connectorPoint.x, parentY, connectorPoint.x, connectorPoint.y, true, this, function (fromX, fromY, toX, toY) {
                    polyline.segments.push(new primitives.common.MoveSegment(fromX, fromY));
...
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors = function (buffer, paletteManager, parentX, parentY, points, drawToParent, hasArrows) {
	...
	for (index = 0; index < len; index += 1) {
	    ...
	    this.transform.transformPoint(joinPointX, parentY, true, this, function (x, y) {
	        polyline.segments.push(new primitives.common.MoveSegment(x, y));
		});//ignore jslint
		switch (this.options.connectorType) {
		    case 1/*primitives.common.ConnectorType.Angular*/:
		        this.transform.transformPoint(point.x, point.y, true, this, function (x, y) {
		            polyline.segments.push(new primitives.common.LineSegment(x, y));
		            ...
		            if (joinPointX > rect.x) {
		                this.transform.transform3Points(rect.right(), rect.verticalCenter(), rect.x, rect.verticalCenter(), rect.x, rect.bottom(), true,
							this, function (cpX1, cpY1, cpX2, cpY2, x, y) {
							    polyline.segments.push(new primitives.common.CubicArcSegment(cpX1, cpY1, cpX2, cpY2, x, y));
							});//ignore jslint
		            }
		            else {
		            ...
		            if (joinPointX > rect.x) {
		                this.transform.transformPoints(rect.x, rect.y, rect.x, rect.bottom(), true,
							this, function (cpX, cpY, x, y) {
							    polyline.segments.push(new primitives.common.QuadraticArcSegment(cpX, cpY, x, y));
							});//ignore jslint
		            } else {
		...
		if (hasArrows && point.visibility != 4/*primitives.common.Visibility.Invisible*/) {
		    polyline.addArrow(this.options.linesWidth, function (segments, paletteItem, endPoint) {
		        var arrowPolyline = buffer.getPolyline(paletteItem),
                    dotPolyline;
		        arrowPolyline.segments = arrowPolyline.segments.concat(segments);
		        ...
		        if (this._debug) {
		            ...
		            dotPolyline.segments.push(new primitives.common.DotSegment(endPoint.x - 1, endPoint.y - 1, 2, 2, 1));
		        }
		    }); //ignore jslint
		}
	}
...
primitives.famdiagram.Controller.prototype._virtualCreateOrgTree = function () {
    var index, len, index2, len2,
        ...
        self = this,
        parsedId,
        itemsHavingSpouses, itemHavingSpouses, spouses,
        orgItemRoot,
        famItemsExtracted,
        tempFamily, fakeParent, fakeChild,
        nodesToRemove,
        families2;
    ...
    if (this.options.items.length > 0) {
        ...
        tempFamily = this._logicalFamily.clone();
        this._logicalFamily.loopTopo(this, function (itemid, item, levelIndex) {
            ...
            for (index = 0, len = this.options.items.length; index < len; index += 1) {
                ...
                if (tempFamily.node(userItem.id) != null) {
                    ...
                    for (index2 = 0, len2 = parents.length; index2 < len2; index2 += 1) {
                        ...
                        this._logicalFamily.removeRelation(parents[index2], userItem.id);
                    }
                    ...
                    this._logicalFamily.add([], fakeParent.id, fakeParent);
                    this._logicalFamily.adopt([fakeParent.id], userItem.id);
                    ...
                    for (index2 = 0, len2 = parents.length; index2 < len2; index2 += 1) {
                        ...
                        this._logicalFamily.add([fakeParent.id, parents[index2]], fakeChild.id, fakeChild);
                    }
        ...
        for (index = 0, len = itemsHavingSpouses.length; index < len; index += 1) {
            ...
            spouses.push(itemHavingSpouses.id);
            if (!this._logicalFamily.hasCommonChild(spouses)) {
                ...
                this._logicalFamily.add(spouses, fakeChild.id, fakeChild);
            }
        }
...
primitives.famdiagram.Controller.prototype._addLabelAnnotation = function (logicalFamily, edges, fromItem, toItems, onCreate) {
    ...
    if (isValid) {
        ...
        if (logicalFamily.bundleChildren(commonParentId, bundleItems, bundleItem.id, bundleItem)) {
            bundleItem.levelGravity = 1/*primitives.common.GroupByType.Parents*/;
            isValid = true;
        } else if (logicalFamily.bundleParents(commonParentId, bundleItems, bundleItem.id, bundleItem)) {
...
primitives.famdiagram.FamilyItem = function (arg0) {
    ...
    this.level = null;
    this.levelGravity = 0/*primitives.common.GroupByType.None*/;
