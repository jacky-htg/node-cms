...
primitives.common.SegmentType={Line:0,Move:1,QuadraticArc:2,CubicArc:3,Dot:4};primitives.common.RenderingMode={Create:0,Update:1};primitives.common.PlacementType={Auto:0,TopLeft:8,Top:1,TopRight:2,RightTop:11,Right:3,RightBottom:12,BottomRight:4,Bottom:5,BottomLeft:6,LeftBottom:10,Left:7,LeftTop:9};primitives.common.PageFitMode={None:0,PageWidth:1,PageHeight:2,FitToPage:3,PrintPreview:4};primitives.orgdiagram.PageFitMode=primitives.common.PageFitMode;
primitives.common.OrientationType={Top:0,Bottom:1,Left:2,Right:3};primitives.orgdiagram.OrientationType=primitives.common.OrientationType;primitives.common.LineType={Solid:0,Dotted:1,Dashed:2};primitives.common.Layers={BackgroundAnnotations:1,Connector:2,Highlight:3,Marker:4,Label:5,Cursor:6,Item:7,ForegroundAnnotations:8,Annotation:9,Controls:10};primitives.common.LabelType={Regular:0,Dummy:1,Fixed:2};
...
this.panelSize.height,!1,this,function(a,b,c,d){r=new primitives.common.Size(c,d)});q=Math.max(this.hasLabel?n.width:0,5*m);if(a.right()+q<b.left()||a.left()>b.right()+q)if(a.left()>b.right()?(d=new primitives.common.Point(a.left(),a.verticalCenter()),e=new primitives.common.Point(b.right(),b.verticalCenter()),q=7,s=3):(d=new primitives.common.Point(a.right(),a.verticalCenter()),e=new primitives.common.Point(b.left(),b.verticalCenter()),q=3,s=7),f=new primitives.common.Rect(d,e),l=d.y<=e.y,k=d.x<
e.x,f.height<f.width){f.height<2*m&&f.offset(0,l?2*m:0,0,l?0:2*m);g=0;for(h=j.length;g<h;g+=1)i=j[g],u.addInverted(function(a){a=a.getPolyline(t);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+i));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(l?f.top():f.bottom())+i,e.x,e.y+i))},!g),v.addArrow(this.lineWidth,function(a,b){var c=u.getPolyline(b);c.segments=c.segments.concat(a)});j=n.width<2*(f.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,
d.y,f.horizontalCenter(),l?f.top():f.bottom(),e.x,e.y,0.5):new primitives.common.Point(d.x,l?f.top():f.bottom());p=new primitives.common.Rect(j.x+(k?m:-n.width-m),l?j.y-n.height-m:j.y+m,n.width,n.height)}else{g=0;for(h=j.length;g<h;g+=1)i=j[g],u.addInverted(function(a){a=a.getPolyline(t);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+i));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+i*(l!=k?1:-1),(l?f.top():f.bottom())+i,f.horizontalCenter()+i*(l!=k?1:-1),
f.verticalCenter()+i));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+i*(l!=k?1:-1),(l?f.bottom():f.top())+i,e.x,e.y+i))},!g),v.addArrow(this.lineWidth,function(a,b){var c=u.getPolyline(b);c.segments=c.segments.concat(a)});p=new primitives.common.Rect(f.horizontalCenter()+(l!=k?m:-(m+n.width)),f.verticalCenter()-n.height/2,n.width,n.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){k=a.x<r.width/2;d=new primitives.common.Point(k?a.right():a.left(),
a.verticalCenter());e=new primitives.common.Point(k?b.right():b.left(),b.verticalCenter());s=q=k?3:7;f=new primitives.common.Rect(d,e);f.offset(10*m,0,10*m,0);l=d.y<=e.y;g=0;for(h=j.length;g<h;g+=1)i=j[g],u.addInverted(function(a){a=a.getPolyline(t);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+i));a.segments.push(new primitives.common.QuadraticArcSegment(k?f.right()+i*(l?-1:1):f.left()-i*(l?-1:1),f.verticalCenter(),k?b.right():b.left(),b.verticalCenter()-i))},!g),v.addArrow(this.lineWidth,
function(a,b){var c=u.getPolyline(b);c.segments=c.segments.concat(a)});j=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,k?f.right():f.left(),f.verticalCenter(),e.x,e.y,0.5);p=new primitives.common.Rect(j.x+(k?m/2:-m/2-n.width),j.y-n.height/2,n.width,n.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());s=q=1;f=new primitives.common.Rect(d,e);f.offset(0,7*m,0,0);k=d.x<e.x;g=0;for(h=j.length;g<h;g+=
1)i=j[g],u.addInverted(function(a){a=a.getPolyline(t);a.segments.push(new primitives.common.MoveSegment(d.x+i,d.y));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-i*(k?-1:1),b.horizontalCenter()-i,b.top()))},!g),v.addArrow(this.lineWidth,function(a,b){var c=u.getPolyline(b);c.segments=c.segments.concat(a)});j=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,f.horizontalCenter(),f.top(),e.x,e.y,0.5);p=new primitives.common.Rect(j.x-n.width/
2,j.y-(this.labelOffset+n.height),n.width,n.height)}u.transform(this.transform,!0);this.m_graphics.polylinesBuffer(u);if(this.hasLabel){switch(this.labelPlacementType){case primitives.common.ConnectorLabelPlacementType.From:p=this._getLabelPosition(a.x,a.y,a.width,a.height,p.width,p.height,this.labelOffset,q);break;case primitives.common.ConnectorLabelPlacementType.To:p=this._getLabelPosition(b.x,b.y,b.width,b.height,p.width,p.height,this.labelOffset,s)}this.transform.transformRect(p.x,p.y,p.width,
p.height,!0,this,function(a,b,c,d){p=new primitives.common.Rect(a,b,c,d)});this.m_graphics.template(p.x,p.y,0,0,0,0,p.width,p.height,this.labelTemplate,this.labelTemplateHashCode,"onAnnotationLabelTemplateRender",c,null)}};primitives.common.Perimeter=function(a){this.m_graphics=a;this.transform=null;this.opacity=this.lineWidth=1;this.fillColor=null;this.lineType=0;this.borderColor=null};primitives.common.Perimeter.prototype=new primitives.common.BaseShape;
...
}0==c.segments.length&&(f=new primitives.common.MoveSegment(b.fromPoint),c.segments.push(f),h[a.segments.endKey()]={point:f,isVertical:l});i=null!=a.segments.item(b.oppositeKey)?new primitives.common.MoveSegment(b.toPoint.x+i,b.toPoint.y+k):new primitives.common.LineSegment(b.toPoint.x+i,b.toPoint.y+k);c.segments.push(i);0<d&&(l?f.y=i.y:f.x=i.x,null!=e&&(!a.segments.item(e.oppositeKey)&&null!=a.segments.item(b.oppositeKey)?h.hasOwnProperty(b.oppositeKey)?(k=h[b.oppositeKey],k.isVertical?f.y=k.point.y:
f.x=k.point.x,g?k.point.y=f.y:k.point.x=f.x):h[b.oppositeKey]={point:f,isVertical:g}:null!=a.segments.item(e.oppositeKey)&&!a.segments.item(b.oppositeKey)&&(h.hasOwnProperty(e.key)?(k=h[e.key],k.isVertical?f.y=k.point.y:f.x=k.point.x,g?k.point.y=f.y:k.point.x=f.x):h[e.key]={point:f,isVertical:l})),g=l,e=b);f=i});0<d&&!a.segments.item(e.oppositeKey)&&(b=h[e.key],b.isVertical?f.y=b.point.y:f.x=b.point.x,g?b.point.y=f.y:b.point.x=f.x);c.transform(this.transform,!0);this.m_graphics.polyline(c.segments,
c.paletteItem.toAttr())};primitives.common.Shape=function(a){this.m_graphics=a;this.transform=null;this.orientationType=0;this.panelSize=null;this.shapeType=0;this.offset=new primitives.common.Thickness(0,0,0,0);this.lineWidth=1;this.labelOffset=4;this.cornerRadius="10%";this.opacity=1;this.fillColor=null;this.labelSize=new primitives.common.Size(60,30);this.lineType=0;this.borderColor=null;this.hasLabel=!1;this.labelTemplateHashCode=this.labelTemplate=null;this.labelPlacement=0};
primitives.common.Shape.prototype=new primitives.common.BaseShape;
primitives.common.Shape.prototype.draw=function(a,b){var c,d,e,f,g,a=(new primitives.common.Rect(a)).offset(this.offset);this.transform=new primitives.common.Transform;this.transform.size=this.panelSize;this.transform.setOrientation(this.orientationType);this.hasLabel&&(c=this._getLabelPosition(a.x,a.y,a.width,a.height,this.labelSize.width,this.labelSize.height,this.labelOffset,this.labelPlacement));switch(this.shapeType){case 0:f=new primitives.common.Callout(this.m_graphics);f.cornerRadius=this.cornerRadius;
f.opacity=this.opacity;f.lineWidth=this.lineWidth;f.lineType=this.lineType;f.borderColor=this.borderColor;f.fillColor=this.fillColor;f.draw(null,a);break;default:g=new primitives.common.PaletteItem({lineColor:this.borderColor,lineWidth:this.lineWidth,lineType:this.lineType,fillColor:this.fillColor,opacity:this.opacity});f=new primitives.common.PolylinesBuffer;g=f.getPolyline(g);this.transform.transformRect(a.x,a.y,a.width,a.height,!1,this,function(b,c,d,e){a=new primitives.common.Rect(b,c,d,e)});
switch(this.shapeType){case 4:d=Math.min(a.width/2,a.height/2),a=new primitives.common.Rect(a.horizontalCenter()-d,a.verticalCenter()-d,2*d,2*d);case 1:d=0.5522848*(a.width/2);e=0.5522848*(a.height/2);g.segments.push(new primitives.common.MoveSegment(a.x,a.verticalCenter()));g.segments.push(new primitives.common.CubicArcSegment(a.x,a.verticalCenter()-e,a.horizontalCenter()-d,a.y,a.horizontalCenter(),a.y));g.segments.push(new primitives.common.CubicArcSegment(a.horizontalCenter()+d,a.y,a.right(),a.verticalCenter()-
e,a.right(),a.verticalCenter()));g.segments.push(new primitives.common.CubicArcSegment(a.right(),a.verticalCenter()+e,a.horizontalCenter()+d,a.bottom(),a.horizontalCenter(),a.bottom()));g.segments.push(new primitives.common.CubicArcSegment(a.horizontalCenter()-d,a.bottom(),a.x,a.verticalCenter()+e,a.x,a.verticalCenter()));break;case 5:g.segments.push(new primitives.common.MoveSegment(a.horizontalCenter(),a.bottom()));g.segments.push(new primitives.common.LineSegment(a.left(),a.verticalCenter()));
g.segments.push(new primitives.common.LineSegment(a.horizontalCenter(),a.y));g.segments.push(new primitives.common.LineSegment(a.right(),a.verticalCenter()));g.segments.push(new primitives.common.LineSegment(a.horizontalCenter(),a.bottom()));break;case 2:g.segments.push(new primitives.common.MoveSegment(a.left(),a.bottom()));g.segments.push(new primitives.common.LineSegment(a.horizontalCenter(),a.y));g.segments.push(new primitives.common.LineSegment(a.right(),a.bottom()));g.segments.push(new primitives.common.LineSegment(a.left(),
a.bottom()));break;case 3:g.segments.push(new primitives.common.MoveSegment(a.horizontalCenter(),a.verticalCenter())),g.segments.push(new primitives.common.LineSegment(a.x,a.y)),g.segments.push(new primitives.common.MoveSegment(a.horizontalCenter(),a.verticalCenter())),g.segments.push(new primitives.common.LineSegment(a.right(),a.bottom())),g.segments.push(new primitives.common.MoveSegment(a.horizontalCenter(),a.verticalCenter())),g.segments.push(new primitives.common.LineSegment(a.right(),a.y)),
g.segments.push(new primitives.common.MoveSegment(a.horizontalCenter(),a.verticalCenter())),g.segments.push(new primitives.common.LineSegment(a.left(),a.bottom()))}f.transform(this.transform,!0);this.m_graphics.polylinesBuffer(f)}this.hasLabel&&this.m_graphics.template(c.x,c.y,0,0,0,0,c.width,c.height,this.labelTemplate,this.labelTemplateHashCode,"onAnnotationLabelTemplateRender",b,null)};
primitives.common.Point=function(a,b){this.y=this.x=null;switch(arguments.length){case 1:this.x=a.x;this.y=a.y;break;case 2:this.x=a,this.y=b}};primitives.common.Point.prototype.distanceTo=function(a,b){var c=0,d=0;switch(arguments.length){case 1:c=a.x;d=a.y;break;case 2:c=a,d=b}c=this.x-c;d=this.y-d;return Math.sqrt(c*c+d*d)};primitives.common.Point.prototype.swap=function(a){var b=a.x,c=a.y;a.x=this.x;a.y=this.y;this.x=b;this.y=c};primitives.common.Point.prototype.clone=function(){return new primitives.common.Point(this)};
primitives.common.Point.prototype.toString=function(a){var b,a=void 0!==a?a:"px";b=""+("left:"+this.x+a+";");return b+="top:"+this.y+a+";"};primitives.common.MoveSegment=function(){this.parent=primitives.common.Point.prototype;this.parent.constructor.apply(this,arguments);this.segmentType=1};primitives.common.MoveSegment.prototype=new primitives.common.Point;primitives.common.MoveSegment.prototype.getEndPoint=function(){return this};
primitives.common.MoveSegment.prototype.invert=function(a){this.x=a.x;this.y=a.y};primitives.common.MoveSegment.prototype.transform=function(a,b){var c=this;a.transformPoint(c.x,c.y,b,c,function(a,b){c.x=a;c.y=b})};
...
primitives.common.Polyline=function(a){this.paletteItem=new primitives.common.PaletteItem;this.segments=[];switch(arguments.length){case 1:this.paletteItem=a}this.arrowPaletteItem=new primitives.common.PaletteItem({lineColor:this.paletteItem.lineColor,lineWidth:0,fillColor:this.paletteItem.lineColor,opacity:1})};primitives.common.Polyline.prototype.transform=function(a,b){var c,d,e;c=0;for(d=this.segments.length;c<d;c+=1)e=this.segments[c],null!=e.transform&&e.transform(a,b)};
primitives.common.Polyline.prototype.isInvertable=function(){return primitives.common.isNullOrEmpty(this.paletteItem.fillColor)};primitives.common.Polyline.prototype.addInverted=function(a){var b=a.segments,c,d;if(0<b.length)if(this.isInvertable()){d=b[b.length-1].getEndPoint();this.segments.push(new primitives.common.MoveSegment(d));for(a=b.length-1;0<a;a-=1)c=b[a],d=b[a-1],4!=c.segmentType&&4!=d.segmentType&&(d=d.getEndPoint(),c.invert(d)),this.segments.push(c)}else this.segments=this.segments.concat(b)};
primitives.common.Polyline.prototype.addArrow=function(a,b){var c,d,e;d=this.segments.length;var f;f=8*a;var g=6*a;null!=b&&1<d&&(c=this.segments[d-2].getEndPoint(),e=this.segments[d-1],null!=e.trim&&(d=new primitives.common.Point(e.getEndPoint()),c=e.trim(c,g),f=this._getArrow(c.x,c.y,d.x,d.y,f,g),b(f,this.arrowPaletteItem,c)))};
primitives.common.Polyline.prototype.optimizeMoveSegments=function(){var a,b,c,d,e;c={};var f=[],g=[];a=0;for(b=this.segments.length;a<b-1;a+=1)switch(d=this.segments[a],e=this.segments[a+1],d.segmentType){case 0:case 2:case 3:switch(e.segmentType){case 1:case 4:d=d.x+"&"+d.y,c.hasOwnProperty(d)||(c[d]=a)}break;case 1:d=d.x+"&"+d.y,c.hasOwnProperty(d)&&!f[c[d]]&&(f[c[d]]=a+1,g[a]=!0)}e=[];for(a=0;a<b;a+=1)if(!g[a]&&(d=this.segments[a],e.push(d),g[a]=!0,0<f[a]))for(c=f[a];c<b&&!g[c];)d=this.segments[c],
e.push(d),g[c]=!0,c=0<f[c]?f[c]:c+1;this.segments=e};
primitives.common.Polyline.prototype._getArrow=function(a,b,c,d,e,f){for(var g=[],h,j,e=[new primitives.common.Point(e,-f/2),new primitives.common.Point(0,0),new primitives.common.Point(e,f/2),new primitives.common.Point(3*(e/4),0)],i=Math.atan2(b-d,a-c),a=0,b=e.length;a<b;a+=1)f=e[a],h=f.x*Math.cos(i)-f.y*Math.sin(i),j=f.x*Math.sin(i)+f.y*Math.cos(i),f.x=h+c,f.y=j+d;g.push(new primitives.common.MoveSegment(e[0].x,e[0].y));g.push(new primitives.common.LineSegment(e[1].x,e[1].y));g.push(new primitives.common.LineSegment(e[2].x,
e[2].y));g.push(new primitives.common.QuadraticArcSegment(e[3].x,e[3].y,e[0].x,e[0].y));return g};primitives.common.Polyline.prototype.toString=function(){return this.paletteItem.toString()};primitives.common.PolylinesBuffer=function(){this.polylines={}};primitives.common.PolylinesBuffer.prototype._getPolyline=function(a,b){a[b.toString()]||(a[b.toString()]=new primitives.common.Polyline(b));return a[b.toString()]};
primitives.common.PolylinesBuffer.prototype.getPolyline=function(a){return this._getPolyline(this.polylines,a)};primitives.common.PolylinesBuffer.prototype.getPolylines=function(){var a,b,c=[];for(a in this.polylines)if(this.polylines.hasOwnProperty(a)&&(b=this.polylines[a]))b.optimizeMoveSegments(),c.push(b);return c};
primitives.common.PolylinesBuffer.prototype.addInverted=function(a,b){var c,d,e,f;d=this.polylines;this.polylines=[];null!=a&&a(this);for(c in this.polylines)this.polylines.hasOwnProperty(c)&&(e=this._getPolyline(this.polylines,c),f=this._getPolyline(d,e.paletteItem),b?f.segments=f.segments.concat(e.segments):f.addInverted(e));this.polylines=d};
primitives.common.PolylinesBuffer.prototype.transform=function(a,b){var c,d;for(c in this.polylines)this.polylines.hasOwnProperty(c)&&(d=this.polylines[c])&&d.transform(a,b)};primitives.common.QuadraticArcSegment=function(a,b,c,d){this.cpY=this.cpX=this.y=this.x=null;switch(arguments.length){case 2:this.x=b.x;this.y=b.y;this.cpX=a.x;this.cpY=a.y;break;case 4:this.cpX=a,this.cpY=b,this.x=c,this.y=d}this.segmentType=2};primitives.common.QuadraticArcSegment.prototype.getEndPoint=function(){return this};
primitives.common.QuadraticArcSegment.prototype.invert=function(a){this.x=a.x;this.y=a.y};primitives.common.QuadraticArcSegment.prototype.transform=function(a,b){var c=this;a.transformPoints(c.x,c.y,c.cpX,c.cpY,b,c,function(a,b,f,g){c.x=a;c.y=b;c.cpX=f;c.cpY=g})};
...
primitives.orgdiagram.BaseController.prototype._redrawTreeItems=function(){var a,b,c,d={},e,f,g,h;this.transform.setOrientation(this.options.orientationType);f=0;for(g=this._treeLevels.length;f<g;f+=1)a=this._treeLevels[f],a.labels=[],a.labelsRect=null,a.hasFixedLabels=!1,a.showLabels=!0;this._visualTree.loop(this,function(a,f){var g=f.orgItem,l=this._treeLevels[f.level];f.setActualPosition(l,this.options);this.transform.transformRect(f.actualPosition.x,f.actualPosition.y,f.actualPosition.width,f.actualPosition.height,
!0,this,function(a,j,p,q){switch(f.actualVisibility){case 1:b=new primitives.common.RenderEventArgs;b.context=f.itemConfig;b.isCursor=f.isCursor;b.isSelected=f.isSelected;b.templateName=f.template.name;this.graphics.activate("placeholder",7);this.graphics.template(a,j,p,q,f.contentPosition.x,f.contentPosition.y,f.contentPosition.width,f.contentPosition.height,f.template.itemTemplate,f.template.itemTemplateHashCode,f.template.itemTemplateRenderName,b,{"border-width":f.template.itemBorderWidth});f.actualHasGroupTitle&&
this.graphics.template(a,j,p,q,2,f.contentPosition.y,this.options.groupTitlePanelSize-4,f.contentPosition.height+2,this._groupTitleTemplate,this._groupTitleTemplateHashCode,"onGroupTitleTemplateRender",f,null);f.actualHasSelectorCheckbox&&(this.graphics.activate("placeholder",10),this.graphics.template(a,j,p,q,f.contentPosition.x,f.actualSize.height-(this.options.checkBoxPanelSize-4),f.contentPosition.width,this.options.checkBoxPanelSize-4,this._checkBoxTemplate,this._checkBoxTemplateHashCode,"onCheckBoxTemplateRender",
...
p,q),h.weight=1E4,h.labelType=1,l.labels.push(h));break;case 2:c=g.itemTitleColor;null==c&&(c="#000080");d.hasOwnProperty(c)||(d[c]=[]);e=d[c];e.push(new primitives.common.DotSegment(a,j,p,q,f.template.minimizedItemCornerRadius));h=this._createLabel(a,j,p,q,f);null!=h&&l.labels.push(h);break;default:this._debug&&(c="#ff0000",d.hasOwnProperty(c)||(d[c]=[]),e=d[c],e.push(new primitives.common.DotSegment(a-1,j-1,2,2,1)))}})});this.graphics.activate("placeholder",4);for(c in d)d.hasOwnProperty(c)&&(e=
d[c],a={fillColor:c,borderColor:c,opacity:1,lineWidth:1,lineType:0},this.graphics.polyline(e,a));this._redrawLabels()};
...
d,k.x,k.y,!0,this,function(b,c){var d=Math.round(q.options.elbowDotSize/2);a.getPolyline(p.arrowPaletteItem).segments.push(new primitives.common.DotSegment(b-d,c-d,2*d,2*d,d))})}l[k.connectorStyleType]=Math.min(l[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x);i[k.connectorStyleType]=Math.max(i[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x)}m=[Math.max(0,f-1),Math.min(j+1,e.length-1)];for(n=0;n<m.length;n+=1)k=e[m[n]],l[k.connectorStyleType]=Math.min(l[k.connectorStyleType],k.hasElbow?
k.elbowPoint2.x:k.x),i[k.connectorStyleType]=Math.max(i[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x);k=c;for(n=2;0<=n;n-=1)m=b.getPalette(n),p=a.getPolyline(m),m=l[n],null!=m&&m<k&&(this.transform.transformPoints(k,d,m,d,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.MoveSegment(a,b));p.segments.push(new primitives.common.LineSegment(c,d))}),k=m),m=i[n],null!=m&&m>c&&(this.transform.transformPoints(c,d,m,d,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.MoveSegment(a,
b));p.segments.push(new primitives.common.LineSegment(c,d))}),c=m);for(n=f;n<=j;n+=1)k=e[n],m=b.getPalette(k.connectorStyleType),p=a.getPolyline(m),k.hasElbow?(this.transform.transform3Points(k.elbowPoint2.x,k.elbowPoint2.y,k.elbowPoint1.x,k.elbowPoint2.y,k.elbowPoint1.x,k.elbowPoint1.y,!0,this,function(a,b,c,d,e,f){switch(this.options.elbowType){case 2:p.segments.push(new primitives.common.MoveSegment(a,b));p.segments.push(new primitives.common.LineSegment(e,f));break;case 3:p.segments.push(new primitives.common.MoveSegment(a,
b)),p.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}}),this.transform.transformPoints(k.elbowPoint1.x,k.elbowPoint1.y,k.x,k.y,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.LineSegment(c,d))})):this.transform.transformPoints(k.x,d,k.x,k.y,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.MoveSegment(a,b));p.segments.push(new primitives.common.LineSegment(c,d))}),g&&(h&&4!=k.visibility)&&p.addArrow(this.options.linesWidth,function(b,c){var d=a.getPolyline(c);
d.segments=d.segments.concat(b)})}else this._drawAngularConnectors(a,b,c,d,e,!0,h)};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors=function(a,b,c,d,e,f,g){var h=null,j=e.length,i,k,l,m,h=f?c:e[j-1].x;k=new primitives.common.Point(h,d);for(c=0;c<j;c+=1){l=e[c];i=b.getPalette(l.connectorStyleType);m=a.getPolyline(i);this.transform.transformPoint(h,d,!0,this,function(a,b){m.segments.push(new primitives.common.MoveSegment(a,b))});switch(this.options.connectorType){case 1:this.transform.transformPoint(l.x,l.y,!0,this,function(a,b){m.segments.push(new primitives.common.LineSegment(a,
b))});break;case 2:i=new primitives.common.Rect(k,l),f?h>i.x?this.transform.transform3Points(i.right(),i.verticalCenter(),i.x,i.verticalCenter(),i.x,i.bottom(),!0,this,function(a,b,c,d,e,f){m.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):this.transform.transform3Points(i.x,i.verticalCenter(),i.right(),i.verticalCenter(),i.right(),i.bottom(),!0,this,function(a,b,c,d,e,f){m.segments.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):h>i.x?this.transform.transformPoints(i.x,
i.y,i.x,i.bottom(),!0,this,function(a,b,c,d){m.segments.push(new primitives.common.QuadraticArcSegment(a,b,c,d))}):this.transform.transformPoints(i.right(),i.y,i.right(),i.bottom(),!0,this,function(a,b,c,d){m.segments.push(new primitives.common.QuadraticArcSegment(a,b,c,d))})}g&&4!=l.visibility&&m.addArrow(this.options.linesWidth,function(b,c,d){c=a.getPolyline(c);c.segments=c.segments.concat(b);this._debug&&(b=a.getPolyline({fillColor:"#ff0000"}),b.segments.push(new primitives.common.DotSegment(d.x-
1,d.y-1,2,2,1)))})}};primitives.orgdiagram.BaseController.prototype._centerOnCursor=function(a,b){var c;if(null!==a&&(this.graphics.activate("placeholder",7),c=this._getTransformedItemPosition(a),b||this._isAnnotationNeeded(a,this._getPanelPosition())))this.m_scrollPanel.scrollLeft(c.horizontalCenter()-this.m_scrollPanelRect.horizontalCenter()),this.m_scrollPanel.scrollTop(c.verticalCenter()-this.m_scrollPanelRect.verticalCenter())};
...
i-1;e=this._visualTree.hasChildren(a.id);c=a;for(f=0;f<i-1;f+=1)c=this._createNewVisualAggregator(c,!e)}k=[];f=0;for(g=b.length;f<g;f+=1){q=b[f];h=k[f]=0;for(j=q.length;h<j;h+=1)k[f]=Math.max(k[f],this._getItemDepth(q[h]))}f=0;for(g=k.length;f<g;f+=1)if(l=k[f],1<l){h=0;for(j=d[f].length;h<j;h+=1)if(n=d[f][h],this._visualTree.hasChildren(n.id))for(i=l;1<i;)n=this._createNewVisualAggregator(n,!1),i-=1}null!=t[a.id]&&this._layoutPartners(a,t[a.id])}})};
...
l;){m=k.segments.item(l);d.hasOwnProperty(m.oppositeKey)&&(i=d[m.oppositeKey],g.hasOwnProperty(i.id)&&!g[i.id]&&(g[i.id]=!0,i.segments.iterateBack(function(a){a.key!=m.oppositeKey&&k.segments.insertAfter(l,a.key,a)},m.oppositeKey,null),i.segments.iterateBack(function(a){k.segments.insertAfter(l,a.key,a)},null,m.oppositeKey)));i=k.segments;for(var n=m,p=i.nextKey(n.key),q=void 0;null!=n&&n.oppositeKey==(q=p||i.startKey());)null!=p&&(p=i.nextKey(p)),i.remove(n.key),i.remove(q),n=i.item(null!=p?i.prevKey(p):
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,j,i,k,l,m,n,p,q;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];i=d.length;k=e.length;j=h=0;p=m=n=l=null;0<i&&(l=d[h],n=!b?l:b(l));0<k&&(m=e[j],p=!b?m:b(m));for(q=null;h<i||j<k;)if(h>=i){if(!c||q!=m)f.push(m),q=m;j+=1;j<k&&(m=e[j],p=!b?m:b(m))}else if(j>=k){if(!c||q!=l)f.push(l),q=l;h+=1;h<i&&(l=d[h],n=!b?l:b(l))}else if(n<p){if(!c||q!=l)f.push(l),q=l;h+=1;h<i&&(l=d[h],n=!b?l:b(l))}else{if(!c||q!=m)f.push(m),
q=m;j+=1;j<k&&(m=e[j],p=!b?m:b(m))}d=f}}return d};
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,j,i,k=[],l,m,n,p,q,s,r={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;n=f.startIndex;r[n]=d+1;p=f.endIndex;r[p]=e;i=k.length;if(0<i){l=[];s=q=!1;for(j=0;j<i;j+=1)m=k[j],m<n?(l.push(m),d=r[m],e=r[m]):m<p?(q||(l.push(n),q=!0),d=Math.max(d,r[m]),e=r[m]):(q||(l.push(n),q=!0),s||(l.push(p),s=!0,r[n]=d+1,r[p]=e),l.push(m));q||(l.push(n),q=!0);s||(l.push(p),s=!0,r[n]=
d+1,r[p]=e);k=l}else k=[n,p];b(f,r[n]);c=Math.max(c,r[n])}return c};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,j;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),j=a[g],d=b(j),0<=d)c=j;else{d=Math.abs(d);e>d&&(e=d,c=j);for(;f+1<g;)if(h=Math.round((f+g)/2),j=a[h],d=b(j),0==d){c=j;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=j)}return c};
primitives.common.family=function(){function a(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e))break}function b(a,b){var c=!1;null!=s[a]&&null!=s[a][b]&&(delete s[a][b],r[a]-=1,delete t[b][a],u[b]-=1,r[a]||(delete s[a],delete r[a]),t[b]||(delete t[b],delete u[b],null==p[null]&&(p[null]={},q[null]=0),p[null][b]=!0,q[null]+=1),c=!0);return c}function c(a,b){var c;if(null!=b)for(c in v)if(v.hasOwnProperty(c)&&b.call(a,c,v[c]))break}function d(b,c,d,e){for(var f,
g,i={},h=0,j=!0;j;){f={};j=!1;for(g in d)if(d.hasOwnProperty(g)&&!i[g])switch(i[g]=!0,e.call(b,g,v[g],h)){case w:f={};j=!1;break;case x:break;default:a(this,c,g,function(a){i[a]||(j=f[a]=!0)})}d=f;h+=1}}function e(a,b,c){null!=c&&null!=b&&(null!=v[b]&&null!=s[b])&&d(a,s,s[b],c)}function f(a,b,c){null!=c&&null!=b&&(null!=v[b]&&null!=t[b])&&d(a,t,t[b],c)}function g(b,c,d,e,f,g){var i,h,j,k;if(null!=g){c=[];h={};for(i in v)v.hasOwnProperty(i)&&(h[i]=d[i]||0,h[i]||c.push(i));for(k=0;0<c.length;){j=[];
d=0;for(f=c.length;d<f;d+=1){i=c[d];if(g.call(b,i,v[i],k)){j=[];break}k+=1;a(this,e,i,function(a){h[a]-=1;0==h[a]&&j.push(a)})}c=j}}}function h(a,b){g(a,t,u,s,r,b)}function j(a,b){g(a,s,r,t,u,b)}function i(a,b,c,d,e,f,g,i,h){var j=!1,k,l;if(null!=v[a]&&null!=g[a]){j=!0;if(h){h=0;for(k=b.length;h<k;h+=1)if(l=b[h],null==v[l]||null==g[a][l])j=!1}if(j&&(null!=d&&(v[c]=d),null!=v[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},i[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,i[a]+=1);h=0;for(k=b.length;h<
k;h+=1)l=b[h],c!=l&&(null!=g[a][l]&&(delete g[a][l],i[a]-=1),null!=e[l][a]&&(delete e[l][a],f[l]-=1),e[l][c]||(e[l][c]=!0,f[l]+=1),g[c][l]||(g[c][l]=!0,i[c]+=1))}}return j}function k(a,b,c,d){return i(a,b,c,d,t,u,s,r,!0)}function l(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function m(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function n(b){var c=primitives.common.graph(),d,e,f,g,i,h,j,k,l={};for(d in b)b.hasOwnProperty(d)&&
a(this,s,d,function(d){if(!l.hasOwnProperty(d)){l[d]=!0;e=[];a(this,t,d,function(a){e.push(a)});f=0;for(i=e.length;f<i-1;f+=1)if(h=e[f],b.hasOwnProperty(h))for(g=f+1;g<i;g+=1)if(j=e[g],b.hasOwnProperty(j)){k=Math.abs(b[h].children.length-b[j].children.length);var n=c.edge(h,j);null==n&&(n=new m(k),c.addEdge(h,j,n));n.items.push(d);n.weight+=1}}});return c}var p={},q={},s={},r={},t={},u={},v={},w=1,x=2;return{add:function(b,c,d){var e,f,g={};if(!b||0==b.length)b=[null];if(null==v[c]&&null!=d){v[c]=
d;d=0;for(e=b.length;d<e;d+=1)f=b[d],null==g[f]&&f!=c&&(g[f]=!0,null!=v[f]?(null==t[c]&&(t[c]={},u[c]=0),t[c][f]||(t[c][f]=!0,u[c]+=1),null==s[f]&&(s[f]={},r[f]=0),s[f][c]||(s[f][c]=!0,r[f]+=1)):(null==p[f]&&(p[f]={},q[f]=0),p[f][c]||(p[f][c]=!0,q[f]+=1)));null!=p[c]&&(s[c]=p[c],r[c]=q[c],delete p[c],delete q[c],a(this,s,c,function(a){null==t[a]&&(t[a]={},u[a]=0);t[a][c]||(t[a][c]=!0,u[a]+=1)}))}},adopt:function(a,b){var c,d,e;if(null!=v[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==t[b]&&(t[b]=
{},u[b]=0),e!=b&&null!=v[e])t[b][e]||(t[b][e]=!0,u[b]+=1),null==s[e]&&(s[e]={},r[e]=0),s[e][b]||(s[e][b]=!0,r[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}else throw"Child should be in hierarchy!";},bundleChildren:k,bundleParents:function(a,b,c,d){return i(a,b,c,d,s,r,t,u,!0)},optimizeReferences:function(b){var c={},d={},f={},g,h,j,k,m,p;if(null!=b){for(g in v)v.hasOwnProperty(g)&&(h=new l,a(this,s,g,function(a){h.children.push(a);h.childrenHash[a]=
!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),f[h.id]=h);for(;!primitives.common.isEmptyObject(f);){j={};k=n(f);for(g in f)f.hasOwnProperty(g)&&(m=f[g],m.processed||(p=k.getSpanningTree(g,function(a,b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),p.loopLevels(this,function(a,g){f[a].processed=!0;p.loopChildren(this,a,function(h,m){var n=k.edge(a,h),p=null,q,A,L,y,H;f[h].processed=!0;if(1<n.weight){A=n.items.join(",");if(c.hasOwnProperty(A))p=c[A];else{q=
b();v[q.id]=q;p=new l;p.id=q.id;p.key=A;A=0;for(L=n.items.length;A<L;A+=1)p.children.push(n.items[A]),p.childrenHash[n.items[A]]=!0;p.children.sort();c[p.key]=p;d[p.id]=p;j[p.id]=p;y=p.children.slice(0);e(this,g.replacementItem||a,function(a){null!=d[a]&&!p.childrenHash[a]&&(H=!0,e(this,a,function(a){return!p.childrenHash[a]?(H=!1,w):x}),H&&y.push(a));return x});i(g.replacementItem||a,y,p.id,q,t,u,s,r,!1);if(1>=(r[a]||0))g.replacementItem=p.id}if(p.id!=h&&(y=p.children.slice(0),e(this,m.replacementItem||
h,function(a){null!=d[a]&&!p.childrenHash[a]&&(H=!0,e(this,a,function(a){return!p.childrenHash[a]?(H=!1,w):x}),H&&y.push(a));return x}),i(m.replacementItem||h,y,p.id,null,t,u,s,r,!1),1>=(r[h]||0)))m.replacementItem=p.id}})})));f=j}}},eliminateManyToMany:function(b){var c,d;for(c in s)s.hasOwnProperty(c)&&1<(r[c]||0)&&a(this,s,c,function(a){if(1<(u[a]||0))d=b(),k(c,[a],d.id,d)})},removeNode:function(b){null!=v[b]&&(a(this,s,b,function(a){delete t[a][b];u[a]-=1;u[a]||(delete t[a],delete u[a],null==
p[null]&&(p[null]={},q[null]=0),p[null][a]||(p[null][a]=!0,q[null]+=1))}),a(this,t,b,function(a){delete s[a][b];r[a]-=1;r[a]||(delete s[a],delete r[a])}),null!=p[null]&&null!=p[null][b]&&(delete p[null][b],q[null]-=1,q[null]||(delete p[null],delete q[null])),delete s[b],delete r[b],delete t[b],delete u[b],delete v[b])},removeRelation:function(a,c){var d=!1;null!=v[a]&&null!=v[c]&&(d=b(a,c)||b(c,a));return d},node:function(a){return v[a]},loop:c,loopLevels:function(b,c,d){function e(){this.items={};
this.minimumLevel=null}function f(a,b,c){var d=n[b];d||(d=new e,n[b]=d);d.addItemToLevel(a,c);x=null==x?c:Math.min(x,c);m[a]=c;k[a]=!0}var g=[],i={},k={},l=[],m={},n={},p,q,r,u,w,x=null;r=c?h:j;var J,D,y,F,B,E,K,I;e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){r(this,function(a,b,c){g.push(a);i[a]=c});r=0;for(J=g.length;r<J;r+=1)if(p=g[r],null==k[p]){l.push(p);for(f(p,
r,0);0<l.length;){B=F=y=null;E=!c;K=[];p=0;for(u=l.length;p<u;p+=1)w=l[p],D=m[w],I=!1,c?(a(this,t,w,function(a){var b;if(!k[a]&&(I=!0,b=i[a],null==y||!E||y<b||y==b&&B>D-1))y=b,F=a,B=D-1,E=!0}),a(this,s,w,function(a){var b;if(!k[a]&&(I=!0,b=i[a],null==y||!E&&(y>b||y==b&&B<D+1)))y=b,F=a,B=D+1,E=!1})):(a(this,s,w,function(a){var b;if(!k[a]&&(I=!0,b=i[a],null==y||E||y<b||y==b&&B<D+1))y=b,F=a,B=D+1,E=!1}),a(this,t,w,function(a){var b;if(!k[a]&&(I=!0,b=i[a],null==y||E&&(y>b||y==b&&B>D-1)))y=b,F=a,B=D-1,
E=!0})),I&&K.push(w);null!=F&&(K.push(F),f(F,r,B));l=K}}l=!0;for(c=x;l;){p={};l=!1;for(q in n)if(n.hasOwnProperty(q)&&(r=n[q],u=r.items[r.minimumLevel-x+c],null!=u)){p[q]=r;l=!0;r=0;for(J=u.length;r<J;r+=1)if(w=u[r],d.call(b,w,v[w],c-x))return l=!1,!0}n=p;c+=1}}},loopTopo:h,loopTopoReversed:j,loopChildren:e,loopParents:f,findLargestRoot:function(){var a=null,b,c={},d={},e;b=null;j(this,function(g,i){c.hasOwnProperty(g)||(c[g]={},d[g]=0);c[g][g]=!0;d[g]+=1;e=!0;f(this,i.id,function(a){var b,f;e=!1;
c.hasOwnProperty(a)||(c[a]={},d[a]=0);if(!d[a]&&1==u[g])c[a]=c[g],d[a]=d[g];else for(f in b=c[g],b)b.hasOwnProperty(f)&&(c[a][f]=!0,d[a]+=1);return x});if(e&&(!b||d[g]>b))b=d[g],a=g});return a},loopRoots:function(a,b){var c=null,d,e=0,g={},i={},h,k={},l={},m,n,p,q,r,s,t;j(this,function(a,b){g.hasOwnProperty(a)||(g[a]={},i[a]=0);g[a][a]=!0;i[a]+=1;h=!0;f(this,b.id,function(b){var c,d;h=!1;g.hasOwnProperty(b)||(g[b]={},i[b]=0);if(!i[b]&&1==u[a])g[b]=g[a],i[b]=i[a];else for(d in c=g[a],c)c.hasOwnProperty(d)&&
!g[b][d]&&(g[b][d]=!0,i[b]+=1);return x});h&&(k[a]=!0,e+=1)});q={};for(p in k)if(k.hasOwnProperty(p))for(n in d=g[p],d)d.hasOwnProperty(n)&&(q[n]||(q[n]=[]),q[n].push(p.toString()));for(;0<e;){d=null;for(m in k)if(k.hasOwnProperty(m)&&(!d||i[m]<d))d=i[m],c=m;if(null!=c){null!=b&&b.call(a,c,v[c]);d=g[c];for(n in d)if(d.hasOwnProperty(n)&&!l[n]){p=q[n];s=0;for(t=p.length;s<t;s+=1)r=p[s],i[r]-=1;l[n]=!0}delete k[c];e-=1}}},hasNodes:function(){return!primitives.common.isEmptyObject(v)},hasCommonChild:function(b){var c=
!1,d,e,f,g,i,h,j;d={};g=f=0;for(i=b.length;g<i;g+=1)h=b[g],null!=v[h]&&!d[h]&&(d[h]=!0,f+=1);e={};for(h in d)d.hasOwnProperty(h)&&a(this,s,h,function(a){e[a]=e[a]?e[a]+1:1});for(j in e)if(e.hasOwnProperty(j)&&null!=t[j]&&(u[j]||0)==e[j]&&e[j]==f){c=!0;break}return c},loopNeighbours:function(a,b,c){var d={};null!=c&&(e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=x,f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,2)&&(d[b]=x));return d[b]})));return d[b]}),
f(this,b,function(b,f){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,f,1)&&(d[b]=x,e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=!0,c.call(a,b,e,2)&&(d[b]=x));return d[b]})));return d[b]}))},countChildren:function(a){return r[a]||0},countParents:function(a){return u[a]||0},firstParent:function(a){var b=null,a=t[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},firstChild:function(a){var b=null,a=s[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},validate:function(b){function d(a){var b=
...
e+" missmatch."),!1;if(t.hasOwnProperty(e)&&!v.hasOwnProperty(e))return null!=b&&(b.message="Orphant parents for item #"+e),!1}for(f in s)if(s.hasOwnProperty(f)){if((r[f]||0)!=d(s[f]))return null!=b&&(b.message="Children count for item "+f+" missmatch."),!1;if(s.hasOwnProperty(f)&&!v.hasOwnProperty(f))return null!=b&&(b.message="Orphant children of item "+f),!1}for(f in p)if(p.hasOwnProperty(f)){if((q[f]||0)!=d(p[f]))return null!=b&&(b.message="Root children count for item @"+f+" missmatch."),!1;
a(this,p,f,function(a){if(!v.hasOwnProperty(a))return null!=b&&(b.message="Child #"+a+"of root #"+f+" does not exists."),!1})}return!0},clone:function(){var a=primitives.common.family();c(this,function(b,c){var d=[];f(this,b,function(a){d.push(a);return x});a.add(d,b,c)});return a},BREAK:w,SKIP:x}};
primitives.common.graph=function(){var a={};return{addEdge:function(b,c,d){if((null==a[b]||null==a[b][c])&&null!=d)null==a[b]&&(a[b]={}),a[b][c]=d,null==a[c]&&(a[c]={}),a[c][b]=d},edge:function(b,c){var d=null;null!=a[b]&&a[b][c]&&(d=a[b][c]);return d},getSpanningTree:function(b,c){var d=primitives.common.tree(),e={},f,g=[],h,j={},i,k,l,m,n,p,q;e[b]=!0;i=1;j[b]=null;for(d.add(null,b.toString(),{});0<i;){g=[];m=l=k=null;for(f in e)if(e.hasOwnProperty(f)){n=a[f];h=!1;for(p in n)if(n.hasOwnProperty(p)&&
!j.hasOwnProperty(p)&&(q=n[p],h=!0,!l||0<=c(q,l)))k=p,l=q,m=f;h||g.push(f)}if(null==k)break;else e[k]=!0,i+=1,j[k]=m,d.add(m,k,{});h=0;for(k=g.length;h<k;h+=1)delete e[g[h]],i-=1}return d},getGrowthSequence:function(b){var c=[],d,e={},f;d=[];var g,h={},j=0,i,k,l,m,n,p;if(null!=b){d=null;l=0;m=null;for(g in a)if(a.hasOwnProperty(g)){k=a[g];l=0;for(i in k)k.hasOwnProperty(i)&&(l+=b(k[i]));if(l>m||null==m)d=g,m=l}if(null!=d){c.push(d);e[d]=!0;j+=1;for(h[d]=null;0<j;){d=[];k=i=null;l={};for(f in e)if(e.hasOwnProperty(f)){m=
...
1),f.hasOwnProperty(i)?f[i]>l&&e.hasOwnProperty(i)&&(f[i]=l,g[i]=b):(f[i]=l,g[i]=b,e[i]=!0,h+=1));if(b==c)break;else delete e[b],h-=1}for(d=[];null!=c;)d.push(c),c=g[c];return d}}};primitives.common.hashSet=function(){return{addEdge:addEdge,edge:edge,getSpanningTree:getSpanningTree,getGrowthSequence:getGrowthSequence,getShortestPath:getShortestPath}};
...
10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.linesPalette=[];this.showCallout=!0;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.buttonsPanelSize=
28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.distance=3;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=!0;this.printPreviewPageSize=new primitives.common.Size(612,792)};
...
primitives.famdiagram.Controller.prototype._virtualCreateOrgTree=function(){var a,b,c,d,e,f,g,h,j=[],i,k,l,m,n,p,q,s,r,t=this,u,v,w,x,z;this._defaultLabelAnnotationTemplateName=this.widgetEventPrefix+"DefaultLabelAnnotationTemplate";primitives.common.isNullOrEmpty(this.options.defaulLabelAnnotationTemplate)||(this._defaultLabelAnnotationTemplateName=this.options.defaulLabelAnnotationTemplate);this.showElbowDots=this.showInvisibleSubTrees=!0;this._configs=primitives.common.family();this._logicalFamily=
primitives.common.family();this.itemByChildrenKey={};this._orgPartners={};this._families=[];this._orgTree=primitives.common.tree();this.maximumFamItemId=0;this.maximumLevel=this.minimumLevel=null;if(0<this.options.items.length){f=[];a=0;for(b=this.options.items.length;a<b;a+=1)e=this.options.items[a],null!=e&&(this._configs.add(e.parents,e.id,e),d=new primitives.famdiagram.FamilyItem({id:e.id,itemConfig:e,isActive:e.hasOwnProperty("isActive")?e.isActive:!0}),this._logicalFamily.add(e.parents,d.id,
d),c=d.itemConfig.spouses,null!=c&&0<c.length&&f.push(d),c=parseInt(e.id,10),this.maximumFamItemId=Math.max(isNaN(c)?0:c,this.maximumFamItemId));if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";w=this._logicalFamily.clone();this._logicalFamily.loopTopo(this,function(a){w.removeNode(a)});if(w.hasNodes()){a=0;for(b=this.options.items.length;a<b;a+=1)if(e=this.options.items[a],null!=w.node(e.id)){r=[];w.loopParents(this,e.id,function(a){r.push(a);return w.SKIP});
c=0;for(d=r.length;c<d;c+=1)w.removeRelation(r[c],e.id),this._logicalFamily.removeRelation(r[c],e.id);this.maximumFamItemId+=1;g=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:t._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake parent #"+t.maximumFamItemId,description:"This is fake parent item was created by loops reversal."}});this._logicalFamily.add([],g.id,g);this._logicalFamily.adopt([g.id],e.id);c=0;for(d=r.length;c<d;c+=1)this.maximumFamItemId+=
1,e=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:t._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+t.maximumFamItemId,description:"This is fake child item was created by loops reversal."}}),this._logicalFamily.add([g.id,r[c]],e.id,e);x=[];w.loopTopo(this,function(a){x.push(a)});c=0;for(d=x.length;c<d;c+=1)w.removeNode(x[c])}}a=0;for(b=f.length;a<b;a+=1)d=f[a],c=d.itemConfig.spouses.slice(0),c.push(d.id),this._logicalFamily.hasCommonChild(c)||
(this.maximumFamItemId+=1,e=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:t._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+t.maximumFamItemId,description:"This is fake child keeps spouses together."}}),this._logicalFamily.add(c,e.id,e));if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._logicalFamily.loopLevels(this,1==this.options.groupByType,function(a,b,c){b.level=
c});this._addLabelAnnotations(this._logicalFamily,this.options.annotations);if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._logicalFamily.optimizeReferences(function(){t.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:t.maximumFamItemId,isVisible:t._debug,isActive:!1,itemConfig:{title:"bundle #"+t.maximumFamItemId,description:" This item was created by references optimizer."},levelGravity:2})});if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";
this._logicalFamily.eliminateManyToMany(function(){t.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:t.maximumFamItemId,isVisible:t._debug,isActive:!1,itemConfig:{title:"dummy #"+t.maximumFamItemId,description:"This is item used to eliminate M:M relations."},levelGravity:2})});if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._resortItemsBylevels(this._logicalFamily);this._debug&&this._validate(this._logicalFamily,!1);this._fillInItems(this._logicalFamily,
function(){t.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:t.maximumFamItemId,levelGravity:2,isVisible:t._debug,isActive:!1,itemConfig:{title:"extension #"+t.maximumFamItemId,description:"This is item used to fill gaps in levels."}})});this._debug&&this._validate(this._logicalFamily,!0);v={};this.properties="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");
this.defaultItemConfig=new primitives.famdiagram.ItemConfig;k=0;z=[];this._logicalFamily.loopRoots(this,function(a){l=new primitives.famdiagram.Family(k);this._extractOrgChart(a,this._logicalFamily,v,l);this._families.push(l);z.push(l);k+=1});z.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});j=[];i={};if(0<this._families.length){e=primitives.common.graph();a=0;for(b=this._families.length;a<b;a+=1){l=this._families[a];c=0;for(d=l.links.length;c<
d;c+=1)f=l.links[c],g=this._logicalFamily.node(f.fromItem).familyId,h=this._logicalFamily.node(f.toItem).familyId,g!=h&&(e.addEdge(g,h,{weight:0}),e.edge(g,h).weight+=1),this._families[h].backLinks.push(new primitives.famdiagram.FamLink(f.toItem,f.fromItem))}for(;j.length<this._families.length;){a=0;for(b=z.length;a<b;a+=1)l=z[a],i.hasOwnProperty(l.id)||(s=e.getSpanningTree(l.id,function(a,b){return a.weight-b.weight}),null!=s.node(l.id)?(s.loopPostOrder(this,function(a,b,c){var b=this._families[a],
d=this._families[c],e=[],f=this;null!=c&&(d.familyPriority+=b.familyPriority);e=[];s.loopChildren(this,a,function(a){e.push(a)});e.sort(function(a,b){return f._families[a].familyPriority-f._families[b].familyPriority});s.arrangeChildren(a,e)}),s.loopPreOrder(this,function(a){j.push(a);i[a]=!0})):(j.push(l.id),i[l.id]=!0))}}this.maximumFamItemId+=1;u=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);u.hideParentConnection=!0;u.hideChildrenConnection=!0;u.title="internal root";
u.isVisible=!1;u.isActive=!1;u.childIndex=0;e={};a=0;for(b=j.length;a<b;a+=1){l=this._families[j[a]];h={};p=u;q=0;d=l.links.concat(l.backLinks);for(c=0;c<d.length;c+=1)f=d[c],g=this._orgTree.node(f.toItem),this._orgTree.node(f.fromItem),!0==e[g.familyId]&&(m=l.items[0],n=g,n.level>=m.level&&this._orgTree.loopParents(this,n.id,function(a,b){n=b;if(b.level<m.level)return!0}),h[n.id]=h.hasOwnProperty(n.id)?h[n.id]+1:1,q<h[n.id]&&(p=n,q=h[n.id]));this._attachFamilyToOrgChart(p,l);e[l.id]=!0}a=this._getExtraGravity();
...
b,f.fromItem,f.fromItem));return a.SKIP})));for(g in d)if(d.hasOwnProperty(g)){e=d[g];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(h=0;h<e.length;h+=1)f=e[h],this._addLabelAnnotation(a,c,f.fromItem,f.toItems,function(){j.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:j.maximumFamItemId,isVisible:!0,isActive:!1,itemConfig:f})})}}};
primitives.famdiagram.Controller.prototype._addLabelAnnotation=function(a,b,c,d,e){var f,g=!0,h=null,j,i,k,l=[];i=0;for(k=d.length;i<k;i+=1)if(j=d[i],f=b.edge(c,j),null!=f){if(null==h)h=f.getFar(j);else if(h!=f.getFar(j)){g=!1;break}l.push(f.getNear(j))}else{g=!1;break}if(g&&(e=e(),a.bundleChildren(h,l,e.id,e)?(e.levelGravity=1,g=!0):a.bundleParents(h,l,e.id,e)&&(e.levelGravity=2,g=!0),g)){i=0;for(k=d.length;i<k;i+=1)j=d[i],f=b.edge(c,j),f.setFar(j,e.id)}};
...
primitives.famdiagram.Controller.prototype._balanceOrgTree=function(a,b,c){var d,e,f,g,h,j,i,k,l,m,n;a.loopLevels(this,function(p,q){var s=primitives.common.graph(),r={},t=null,u;i=[];a.loopChildren(this,q.id,function(c,f,g){var i;null==t&&(t=f);r[f.id]={};if(b.hasOwnProperty(f.id))for(i in j=b[f.id],j)if(j.hasOwnProperty(i)){m=j[i];r[f.id][i]={};d=0;for(e=m.length;d<e;d+=1)h=m[d],u=h.commonParent==q.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",
f.id!=u&&(s.addEdge(f.id,u,{weight:0}),s.edge(f.id,u).weight+=1,null==r[f.id][i][u]&&(r[f.id][i][u]=0),r[f.id][i][u]+=1)}0<g&&s.addEdge(f.id,t.id,{weight:0})});if(null!=t){n=s.getGrowthSequence(function(a){return a.weight});0==n.length&&(n=[t.id]);k=this._balanceItems(n,"__left__","__right__",r,c);f=0;for(g=k.length;f<g;f+=1)l=a.node(k[f]),l.childIndex=f,i.push(l.id)}a.arrangeChildren(q.id,i)})};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,j,i,k,l,m,n,p,q,s,r,t,u,v,w,x,z,G,C;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));j=0;h.loop(function(a){j+=1;a.position=j});for(g=0;g<a.length;g+=1)if(i=a[g],i!=b&&i!=c)for(x in p=n=m=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){u=e[i];t=r=s=q=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&
(u&&null!=u[b]&&(q+=a.crossings[b]*u[b]),t+=a.crossings[b]);for(b in d[i])if(d[i].hasOwnProperty(b))for(c in f=d[i][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(q+=(a.left[b]||0)-(g.left[b]||0),r+=Math.abs(g.balance+1)):(q+=(a.right[b]||0)-(g.right[b]||0),r+=Math.abs(g.balance-1)),s+=Math.abs(g.position-a.position)));if(null==l||l>q||l==q&&(m>s||m==s&&(n>r||n==r&&p>t)))l=q,k=a,m=s,n=r,p=t}}),v=k.clone(),w=k.clone(),w.itemId=i,h.insertBefore(k,v),h.insertBefore(k,w),j=
w.position=0,h.loop(function(a){var b,c;if(a.id!=w.id){c=e[i];for(b in c)c.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+c[b]:c[b]);j+=1;a.position=j}},w),j=0,h.backwardLoop(function(a){var b,c;if(a.id!=w.id){c=e[i];for(b in e[i])e[i].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+c[b]:c[b]);j-=1;a.position=j}},w),d[i])if(d[i].hasOwnProperty(x))for(G in z=d[i][x],z)z.hasOwnProperty(G)&&(C=h.getSlot(G),null!=C&&(0>C.position?(C.balance+=1,w.balance-=1,h.backwardLoop(function(a){if(a.id!=
w.id)if(a.id!=C.id)a.crossings[x]=a.crossings[x]?a.crossings[x]+z[G]:z[G];else return!0},w)):(C.balance-=1,w.balance+=1,h.loop(function(a){if(a.id!=w.id)if(a.id!=C.id)a.crossings[x]=a.crossings[x]?a.crossings[x]+z[G]:z[G];else return!0},w))));h.loop(function(a){a=a.itemId;null!=a&&(a!=b&&a!=c)&&f.push(a)});return f};
...
primitives.famdiagram.Controller.prototype._virtualShowCursorNeighbours=function(){var a,b;null!==this._cursorTreeItem&&(0===this._cursorTreeItem.visibility&&(this._cursorTreeItem.visibility=1),b=this._cursorTreeItem.itemConfig,null!=b&&this._logicalFamily.loopNeighbours(this,b.id,function(b){if(this._orgTree.node(b).isActive)return a=this._treeItemsByUserId[b],0===a.visibility&&(a.visibility=1),!0}))};primitives.famdiagram.EdgeItem=function(a,b,c,d){this.values=[b,d];this[a]=0;this[c]=1};
primitives.famdiagram.EdgeItem.prototype.getNear=function(a){return this.values[this[a]]};primitives.famdiagram.EdgeItem.prototype.getFar=function(a){return this.values[Math.abs(this[a]-1)]};primitives.famdiagram.EdgeItem.prototype.setNear=function(a,b){this.values[this[a]]=b};primitives.famdiagram.EdgeItem.prototype.setFar=function(a,b){this.values[Math.abs(this[a]-1)]=b};primitives.famdiagram.EdgeItem.prototype.toString=function(){return this.parent+","+this.child};
primitives.famdiagram.ExtraGravity=function(a){this.toParent=this.fromParent=this.commonParent=null;this.level=a};primitives.famdiagram.Family=function(a){this.id=null;this.familyPriority=1;this.childFamilies=[];this.items=[];this.links=[];this.backLinks=[];1==arguments.length&&(this.id=a)};
primitives.famdiagram.FamilyItem=function(a){var b;this.itemConfig=this.familyId=this.id=null;this.isActive=this.isVisible=!0;this.level=null;this.levelGravity=0;this.hideChildrenConnection=this.hideParentConnection=!1;switch(arguments.length){case 1:for(b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}};primitives.famdiagram.FamLink=function(a,b){this.fromItem=a;this.toItem=b};
...
this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.highlightLinesColor="#ff0000";this.highlightLinesWidth=1;this.highlightLinesType=0;this.showCallout=!0;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";
this.calloutLineWidth=1;this.calloutOpacity=0.2;this.leavesPlacementType=this.childrenPlacementType=2;this.maximumColumnsInMatrix=6;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.distance=3;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight=
"normal";this.enablePanning=!0;this.printPreviewPageSize=new primitives.common.Size(612,792)};
...
primitives.orgdiagram.ItemConfig=function(a,b,c,d,e){var f;this.context=this.image=this.description=this.title=this.parent=this.id=null;this.itemTitleColor="#4169e1";this.groupTitle=null;this.groupTitleColor="#4169e1";this.isActive=this.isVisible=!0;this.childrenPlacementType=this.adviserPlacementType=this.itemType=this.hasButtons=this.hasSelectorCheckbox=0;this.templateName=null;this.showCallout=0;this.label=this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=
3;this.labelPlacement=0;switch(arguments.length){case 1:for(f in a)a.hasOwnProperty(f)&&(this[f]=a[f]);break;case 5:this.id=a,this.parent=b,this.title=c,this.description=d,this.image=e}};
...
primitives.orgdiagram.OrgItem=function(){this.image=this.description=this.title=this.context=this.id=null;this.itemTitleColor="#4169e1";this.groupTitle=null;this.groupTitleColor="#4169e1";this.isActive=this.isVisible=!0;this.hasVisibleChildren=!1;this.childrenPlacementType=this.adviserPlacementType=this.itemType=this.hasButtons=this.hasSelectorCheckbox=0;this.templateName=null;this.showCallout=0;this.label=this.calloutTemplateName=null;this.showLabel=0;this.labelSize=null;this.labelOrientation=3;
this.labelPlacement=0;this.level=null;this.hideChildrenConnection=this.hideParentConnection=!1;this.childIndex=null};
